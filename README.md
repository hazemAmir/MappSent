...
## Features
- For context word representation, we train a Skip-Gram model using **Gensim** toolkit ([Radim Rehurek])(https://github.com/RaRe-Technologies/gensim) on a lemmatized training dataset (Qatar Living). 
