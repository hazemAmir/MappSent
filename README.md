...
Due to data size limitations, please download the training data file [train](
http://filex.univ-nantes.fr/get?k=S5lk9SHm0rBZSyeWKcD) and copy it in this directory: **./MappSent/data/train/lempostag/**  
